...
class Gem_Manipulator
{
    ...
    static public function getManipulatorInstance($manipulator)
    {
        ...
        $loader->addPrefixPath('Gem_Manipulator_Adapter', 'Gem/Manipulator/Adapter/');
        $className = $loader->load($manipulator);

        $class = new ReflectionClass($className);

        if (!$class->implementsInterface('Gem_Manipulator_Adapter_Interface')) {
            require_once 'Gem/Manipulator/Exception.php';
            throw new Gem_Manipulator_Exception('Manipulator must implement interface "Gem_Manipulator_Adapter_Interface".');
        }
